<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
	...
	<div class="form">
		...
		<div class="form-item">
			...
			<div class="input"><input type="text" id="txtTimeLength" /></div>
		</div> 
		<div class="form-item">
	...
	<script>
		...
		var getObj = function(){
			$.get("/Project/CoursesServlet?action=get&Id="+Id, function(data){
				...
				if(result.IsOK){
					...
					$("#txtTimeLength").val(result.Data.TimeLength);
		...
		var edit = function(){		
			...
			$.get("/Project/CoursesServlet?action=edit&Id="+Id+"&Name="+Name+"&FilePath="+FilePath+"&TimeLength="+TimeLength+"&Remark="+Remark, function(data){
				var result = JSON.parse(data);
				if(result.IsOK){
					alert("操作成功");
